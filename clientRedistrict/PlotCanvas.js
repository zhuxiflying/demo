var PlotCanvas = Canvas.extend({
    ...
    initialize: function() {
    	_.bindAll(this, 'generateScatterGraph', 'generateLineGraph', 'render', 'resize', 'loadedData', 'getXAxisFormat', 'getYAxisFormat', 'getXDomain', 'getYDomain', 'getSizeDomain', 'getXScale', 'getYScale', 'getXAxisFormat', 'getYAxisFormat', 'formatX', 'formatY', 'formatSize', 'formatColor', 'getColorScale', 'getSizeScale', 'getColorRange');
